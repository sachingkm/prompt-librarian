// Pure, deterministic classifier. No I/O, no Date.now(), no network, no
// Electron, no Node fs/path - safe to import from both main and renderer.
...
import { scoreTier } from '../classifier'
import {
